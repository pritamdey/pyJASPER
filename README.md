...
The main Python3 implementation is in `pyJASPER.py` which contains the `JASPER` class.
...
- `pyJASPER.py`: JASPER sampler implementation.
- `main.ipynb`: notebook for exploratory use.
